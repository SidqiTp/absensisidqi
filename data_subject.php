                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Subject Data</b></h4>
                            <div align="center"><a href="add_subject.php" class="btn btn-success tambah">Add Subject</button></a>
                             <br>
                            <br>
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        <a href="edit_subject.php?id=<?php echo $key->kode; ?>" class="btn btn-primary  waves-effect"><span class="glyphicon glyphicon-pencil"></span></a>
