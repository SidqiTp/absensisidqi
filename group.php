                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <div align="center"><a href="add_group.php" class="btn btn-success tambah">Add Group</button></a>
                             <br>
                            <br>
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        <a href="edit_group.php?id=<?php echo $key->id; ?>" class="btn btn-primary  waves-effect"><span class="glyphicon glyphicon-pencil"></span></a>
